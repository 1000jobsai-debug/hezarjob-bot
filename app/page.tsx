...
import { Send, Copy, Bot, Plus, Mic, Square } from "lucide-react"
...
export default function ChatPage() {
  ...
  const stopRecordingAndTranscribe = async () => {
    if (mediaRecorderRef.current && isRecording) {
      ...
      const transcribedText = "این یک متن نمونه است که از صدای شما تبدیل شده است."
    ...
    <div className="flex h-screen flex-col bg-gray-50" dir="rtl">
      ...
      <footer className="border-t border-gray-200 bg-white px-4 py-3">
        <div className="mx-auto flex max-w-4xl items-center gap-3">
          {/* Transcribing State */}
          {isTranscribing && (
            <div className="flex flex-1 items-center justify-center gap-2 rounded-full bg-gray-100 px-6 py-3">
              ...
              <span className="text-sm font-medium text-gray-600">در حال تبدیل به متن...</span>
            </div>
          )}
          ...
          {isRecording && !isTranscribing && (
            <>
              <Button
                ...
                className="h-11 w-11 shrink-0 rounded-full bg-blue-500 hover:bg-blue-600 p-0 text-white"
              >
                <Send className="h-5 w-5" />
              </Button>

              <div className="flex flex-1 items-center justify-center gap-1 rounded-full bg-gray-700 px-6 py-3">
              ...
              <Button
                ...
                className="h-11 w-11 shrink-0 rounded-full bg-gray-700 p-0 hover:bg-gray-800"
              >
          ...
          {!isRecording && !isTranscribing && (
            <>
              ...
              <Button
                ...
                disabled={isLoading}
                className="h-11 w-11 shrink-0 rounded-full bg-transparent p-0 hover:bg-gray-100 text-gray-500 border border-gray-300"
              >
              ...
              <textarea
                ...
                disabled={isLoading}
                className="max-h-32 min-h-[44px] flex-1 resize-none rounded-3xl border border-gray-300 bg-gray-50 px-4 py-3 text-gray-800 placeholder-gray-400 focus:border-blue-400 focus:bg-white focus:outline-none disabled:bg-gray-100 disabled:text-gray-400"
                rows={1}
              />
            </>
          )}
